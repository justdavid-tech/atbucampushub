...
function Sports() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        setLoading(true);
        const data = await getPostsByCategory('sports');
        setPosts(data);
      } catch (err) {
    ...
    return (
      ...
      <section className="relative bg-gradient-to-br from-[hsl(var(--background))] via-[hsl(210,45%,14%)] to-[hsl(var(--background))] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-5">
          <Trophy className="w-[600px] h-[600px] text-white animate-float" strokeWidth={0.5} />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-white">Feel the</span><br />
              ...
              <p className="text-lg text-gray-300 max-w-xl leading-relaxed">
                From inter-faculty competitions to fitness programs and championship matches,
                stay updated on all sporting activities and achievements at ATBU.
              </p>
              ...
              <div className="flex items-center gap-4 text-sm text-gray-400 pt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>All Sports Facilities</span>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
       ...
       <section className="py-20 pt-12 relative px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-12">
          <div>
            <h2 className="text-3xl font-bold text-white mb-2">Sports News</h2>
            <p className="text-gray-400">Match updates, tournament results, and sports highlights</p>
          </div>
        </div>
        ...
        {loading ? (
            ...
            {filteredPosts.map((post, index) => (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  <img 
                    src={post.imageUrl || 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&auto=format&fit=crop'} 
                    alt={post.title}
          ...
          <div className="text-center py-16 bg-white/5 rounded-2xl border border-white/10">
            ...
            <h3 className="text-xl font-bold text-white mb-2">No Sports News Found</h3>
